...
export const projects: Project[] = [
  {
    id: "codaryn-invoice",
    slug: "codaryn-invoice",
    title: "SaaS de Facturation",
    subtitle: "Devis, factures et suivi clients pour indépendants et PME",
    category: "Application web",
    sector: "Finance & Gestion",
    tags: ["Web", "SaaS", "Facturation", "B2B"],
    description: "Application SaaS de facturation complète : création de devis et factures avec aperçu PDF, gestion des clients, remises, acomptes et suivi des paiements.",
    longDescription: "Outil de facturation moderne conçu pour les indépendants et petites entreprises. Création de documents professionnels avec aperçu temps réel, gestion des clients et tableau de bord financier.",
    context: "Les freelances et PME ont besoin d'un outil de facturation simple mais professionnel, sans abonnement complexe.",
    challenge: "Offrir un générateur de factures et devis à qualité PDF avec calculs automatiques HT/TVA/TTC, remises et acomptes.",
    solution: "Interface d'édition en ligne avec basculement instantané vers un aperçu PDF fidèle, gestion complète du cycle de vente.",
    features: [
      { iconName: "FileText", title: "Création de factures", description: "Éditeur complet avec lignes de facturation, remise globale, acompte et aperçu PDF." },
      { iconName: "ClipboardList", title: "Devis professionnels", description: "Devis avec descriptions par ligne, conditions générales et zone de signature." },
      { iconName: "Users", title: "Gestion clients", description: "Fiche client avec historique des factures, devis et chiffre d'affaires." },
      { iconName: "BarChart3", title: "Dashboard financier", description: "Vue d'ensemble CA, paiements reçus, en attente et en retard." },
      { iconName: "ArrowRightCircle", title: "Conversion devis→facture", description: "Convertir un devis accepté en facture en un clic." },
      { iconName: "Receipt", title: "Suivi des paiements", description: "Statuts Payée / En attente / En retard avec filtres et alertes." },
    ],
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion"],
    techLogos: ["nextjs", "typescript", "tailwindcss"],
    architecture: ["Next.js App Router", "Données statiques de démonstration", "Calculs HT/TVA/TTC côté client", "Aperçu PDF inline"],
    challenges: [
      { title: "Aperçu PDF fidèle", description: "Rendu identique entre le formulaire d'édition et l'aperçu de document." },
      { title: "Calculs temps réel", description: "Remises, acomptes et TVA calculés instantanément à chaque modification." },
    ],
    results: [
      { metric: "< 2min", description: "pour créer une facture complète" },
      { metric: "100%", description: "responsive mobile" },
      { metric: "Multi-TVA", description: "0%, 5.5%, 10%, 20%" },
      { metric: "PDF", description: "aperçu instantané" },
    ],
    role: ["Conception UX", "Développement full-stack", "Déploiement Vercel"],
    ...
    year: "2025",
    demoType: "live",
    demoUrl: "https://codaryn-demo-invoice-r3umrwa2n-mxbhrs-projects.vercel.app",
    confidentialityLevel: "public",
    screenshots: [],
  },
  {
    id: "codaryn-teamboard",
    slug: "codaryn-teamboard",
    title: "Intranet Équipe",
    subtitle: "Gestion de tâches et coordination d'équipe façon Linear",
    category: "Application web",
    sector: "Collaboration & Équipes",
    tags: ["Web", "SaaS", "Kanban", "Équipe"],
    description: "Plateforme intranet collaborative : board Kanban, gestion de projets, profils membres et fil d'activité pour coordonner efficacement une équipe.",
    longDescription: "Outil de gestion d'équipe inspiré de Linear, avec board Kanban, slide-over de détail des tâches, suivi des projets par progression et feed d'activité en temps réel.",
    context: "Les petites équipes ont besoin d'un outil de coordination léger, sans la complexité et le coût des solutions enterprise.",
    challenge: "Offrir une expérience Kanban fluide avec détail des tâches, gestion des priorités et visibilité sur l'activité de l'équipe.",
    solution: "Interface Kanban avec slide-over animé, filtres par projet, profils membres et timeline d'activité groupée par date.",
    features: [
      { iconName: "LayoutDashboard", title: "Board Kanban", description: "3 colonnes (À faire, En cours, Terminé) avec slide-over de détail des tâches." },
      { iconName: "FolderKanban", title: "Projets", description: "Vue projets avec progression, membres assignés et tâches filtrées." },
      { iconName: "Users", title: "Profils membres", description: "Fiche membre avec tâches actives, terminées et activité récente." },
      { iconName: "Activity", title: "Fil d'activité", description: "Timeline des actions récentes groupées par date avec types d'événements colorés." },
      { iconName: "Tag", title: "Priorités et tags", description: "Badges de priorité (Critique, Haute, Normale, Basse) et tags par tâche." },
      { iconName: "Zap", title: "Animations fluides", description: "Transitions Framer Motion sur toutes les pages pour une UX premium." },
    ],
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion"],
    techLogos: ["nextjs", "typescript", "tailwindcss"],
    architecture: ["Next.js App Router", "Données statiques", "Slide-over animé React state", "Stagger animations"],
    challenges: [
      { title: "UX Kanban", description: "Slide-over fluide avec animation spring pour les détails de tâche." },
      { title: "Performance", description: "Filtrage client-side instantané par projet et statut." },
    ],
    results: [
      { metric: "4 modules", description: "Board, Projets, Membres, Activité" },
      { metric: "100%", description: "responsive mobile" },
      { metric: "< 1s", description: "de chargement" },
      { metric: "Framer Motion", description: "animations premium" },
    ],
    role: ["Conception UX", "Développement full-stack", "Déploiement Vercel"],
    ...
    year: "2025",
    demoType: "live",
    demoUrl: "https://codaryn-demo-teamboard-9vvejjcrr-mxbhrs-projects.vercel.app",
    confidentialityLevel: "public",
    screenshots: [],
  },
  {
    ...
    year: "2024",
    demoType: "live",
    demoUrl: "https://codaryn-demo-fleet-4vqtd1f84-mxbhrs-projects.vercel.app",
    confidentialityLevel: "public",
    screenshots: [],
  },
  {
  ...
  },
  {
    ...
    year: "2025",
    demoType: "live",
    demoUrl: "https://codaryn-demo-booking-ahwsr7tw1-mxbhrs-projects.vercel.app",
    confidentialityLevel: "public",
    screenshots: [],
  },
  {
    ...
    year: "2025",
    demoType: "live",
    demoUrl: "https://codaryn-demo-clientportal-7rb29axsm-mxbhrs-projects.vercel.app",
    confidentialityLevel: "public",
    screenshots: [],
  },
];
