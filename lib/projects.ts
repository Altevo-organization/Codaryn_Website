...
export const projects: Project[] = [
  {
    ...
    features: [
      { iconName: "FileText", title: "Création de factures", description: "Éditeur complet avec lignes, remise globale, acompte et aperçu PDF." },
      ...
      { iconName: "Users", title: "Gestion clients", description: "Fiche client avec historique des factures et chiffre d'affaires." },
      { iconName: "BarChart3", title: "Dashboard financier", description: "Vue CA, paiements reçus, en attente et en retard." },
      { iconName: "ArrowRightCircle", title: "Conversion devis→facture", description: "Convertir un devis accepté en facture en un clic." },
      { iconName: "Receipt", title: "Suivi des paiements", description: "Statuts Payée / En attente / En retard avec filtres." },
    ],
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion"],
    techLogos: ["nextjs", "typescript", "tailwindcss"],
    architecture: ["Next.js App Router", "Calculs HT/TVA/TTC côté client", "Aperçu PDF inline"],
    challenges: [
      { title: "Aperçu PDF fidèle", description: "Rendu identique entre formulaire d'édition et aperçu document." },
      { title: "Calculs temps réel", description: "Remises, acomptes et TVA calculés instantanément." },
    ],
    results: [
  ...
  },
  {
    ...
    description: "Plateforme intranet collaborative : board Kanban, gestion de projets, profils membres et fil d'activité pour coordonner une équipe.",
    longDescription: "Outil de gestion d'équipe inspiré de Linear, avec board Kanban, slide-over de détail des tâches, suivi des projets et feed d'activité.",
    context: "Les petites équipes ont besoin d'un outil de coordination léger, sans la complexité des solutions enterprise.",
    challenge: "Offrir une expérience Kanban fluide avec détail des tâches, priorités et visibilité sur l'activité équipe.",
    ...
    features: [
      { iconName: "LayoutDashboard", title: "Board Kanban", description: "3 colonnes avec slide-over de détail des tâches." },
      { iconName: "FolderKanban", title: "Projets", description: "Vue projets avec progression et membres assignés." },
      { iconName: "Users", title: "Profils membres", description: "Fiche membre avec tâches actives et activité récente." },
      { iconName: "Activity", title: "Fil d'activité", description: "Timeline des actions groupées par date." },
      { iconName: "Tag", title: "Priorités et tags", description: "Badges Critique/Haute/Normale/Basse et tags par tâche." },
      { iconName: "Zap", title: "Animations fluides", description: "Transitions Framer Motion premium sur toutes les pages." },
    ],
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion"],
    techLogos: ["nextjs", "typescript", "tailwindcss"],
    architecture: ["Next.js App Router", "Slide-over animé React state", "Stagger animations Framer Motion"],
    challenges: [
