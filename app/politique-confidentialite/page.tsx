          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-slate-400">
                ...
                au bon fonctionnement du site (préférence de thème clair/sombre).
                Ces cookies ne collectent pas de données personnelles et ne
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-slate-400 space-y-2">
                <li>
                  <strong className="text-slate-300">Droit d'accès :</strong>{" "}
                  obtenir la confirmation du traitement de vos données et y
                  accéder
                </li>
                <li>
                  <strong className="text-slate-300">Droit de rectification :</strong>{" "}
                  demander la correction de données inexactes
                </li>
                <li>
                  <strong className="text-slate-300">Droit à l'effacement :</strong>{" "}
                  demander la suppression de vos données
                </li>
                <li>
                  <strong className="text-slate-300">Droit à la limitation :</strong>{" "}
                  demander la limitation du traitement
                </li>
                <li>
                  <strong className="text-slate-300">Droit à la portabilité :</strong>{" "}
                  recevoir vos données dans un format structuré
                </li>
                <li>
                  <strong className="text-slate-300">Droit d'opposition :</strong>{" "}
