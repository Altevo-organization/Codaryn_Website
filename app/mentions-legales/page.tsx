          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="text-zinc-400 space-y-2">
                ...
                <p>
                  <strong className="text-zinc-300">Adresse :</strong> [À compléter]
                </p>
                <p>
                  <strong className="text-zinc-300">SIRET :</strong> [À compléter]
                </p>
                <p>
                ...
                <p>
                  <strong className="text-zinc-300">Téléphone :</strong> +33 6 02 69 92 58
                </p>
                <p>
                  <strong className="text-zinc-300">Directeur de la publication :</strong> [À compléter]
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-zinc-400 space-y-2">
                <p>
                  <strong className="text-zinc-300">Nom :</strong> Vercel Inc.
                </p>
                <p>
                  <strong className="text-zinc-300">Adresse :</strong> 340 S Lemon Ave #4133, Walnut, CA 91789, USA
                </p>
                <p>
                  <strong className="text-zinc-300">Site web :</strong>{" "}
                  <a
